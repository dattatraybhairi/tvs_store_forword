void CC2500_sendPacket(uint8_t pkt_len) {
  ...
  radioPktBuffer[1] = sbuf[0];
  radioPktBuffer[2] = sbuf[1];
  radioPktBuffer[3] = sbuf[2];
  radioPktBuffer[4] = sbuf[3];
  radioPktBuffer[5] = sbuf[4];
//  radioPktBuffer[0] = 5;                  // Length byte
//  radioPktBuffer[1] = 5;
//  radioPktBuffer[2] = 100;
//  radioPktBuffer[3] = 110;
//  radioPktBuffer[4] = 165;
//  radioPktBuffer[5] = 7;  
